...
if(isset($_POST['Submit']))
{
	...
	mysql_query("update users set fname='$fname' ,lname='$lname' , contacttype='$contact' where id='".$_GET['uid']."'");
                  ...
                  <div class="col-md-12">
                      ...
                      <p align="center" style="color:#F00;"><?php echo $_SESSION['msg'];?><?php echo $_SESSION['msg']=""; ?></p>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="contact" value="<?php echo $row['DOB'];?>" >
                              </div>
                          </div>
                            <div class="form-group">
