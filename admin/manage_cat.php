  ...
  <section id="container" >
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Manage Categories</h3>
				<div class="row">
...
<!--				  
                      ...
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
	                  	  	  <h4><i class="fa fa-angle-right"></i> Categories Detail </h4>
	                  	  	  <hr>
                              <thead>
                              <tr>
                                  <th>Sno.</th>
                              ...
                              <td><?php echo $cnt;?></td>
                                  ...
                                  <td>
                                     ...
                                     <a href="update-cat.php?id=<?php echo $row['id'];?>"> 
                                     <button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>
                                     <a href="manage_cat.php?id=<?php echo $row['id'];?>"> 
