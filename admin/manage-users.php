...
check_login();
	if(isset($_GET['id'])) {
			...
			$usertype=mysql_query("select usertype from users where id='".$_GET['id']."'");
			$type=mysql_fetch_assoc($usertype);
			if($type['usertype'] == 2){
				
				echo "<script>alert('Need to approval to that user for delete accout');</script>";
			}else{
